                        ...
                        <div className="member">
                            <div className="member-info">
                                ...
                                <div className="member-text">
                                    <span>Justin Gilfus</span>
                                    <span>CEO</span>
                                </div>
                            </div>
                            <div className="member-about">
                                After joining the Army in 2010 as a Cavalry Scout, Justin deployed to Afghanistan in 2011 and washonorably discharged in 2013. After returning home, he began pursuing his education and developeda career as a successful entrepreneur. Justin was invited to become a part of Ads For The Road,where he transformed the company into an outdoor digital media platform that has forever changed theTexas outdoor advertising market. During his time at Ads For The Road, Justin recognized a need forimproved outdoor advertisement metrics and began developing ABRAXAS Technology. A champion for otherveteran entrepreneurs, Justin is heavily involved in the Austin startup community, working withorganizations such as <a href="https://www.techstars.com/">Techstars</a>,
                                <a href="http://patriotbootcamp.org/">Patriot Boot Camp</a> and
                                <a href="https://bunkerlabs.org/austin/">Bunker Labs</a>.

                            </div>
                        </div>
                        <div className="member">
                            <div className="member-info">
                                <div className="member-image josh"></div>
                                <div className="member-text">
                                    <span>JOSHUA LAWTON-BELOUS </span>
                                    <span>COO</span>
                                </div>
                            </div>
                            <div className="member-about">
                                Joshua is a recovering Trekkie, lifelong investor, part-time writer, and once-upon-a-time combat medic. He is a member of OAAA's Innovations Committee. Joshua led a national pilot for a Presidential Major Initiative as a senior government official, and served as a Senior Consultant at Booz Allen Hamilton focusing on managing high-risk, high-reward research and development efforts, including commercializing game changing technologies. Most recently, as the Director of Project Management at Global Cyber Alliance, Joshua managed a team that built, according to CTO Vision, one of the top four managed DNS services in the world. He is the recipient of the Wells Fargo 2016 Clean Technology Award for developing an innovative and green product line. Joshua holds a Masters of Business Administration from Johns Hopkins University and a Masters in Technology Commercialization from the McCombs School of Business at the University of Texas at Austin. He also is a Project Management Professional (PMP), a Certified ScrumMaster (CSM), and Certified Scrum Product Owner (CSPO).
                            </div>
                        </div>
                        <div className="member">
                            <div className="member-info">
                                <div className="member-image steve"></div>
                                <div className="member-text">
